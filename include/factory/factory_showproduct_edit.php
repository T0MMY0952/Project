          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" name="name" type="text" aria-describedby="nameHelp" value="<?php echo $getprev['p_name'];?>" disabled="disabled" >
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" name="name" type="text" aria-describedby="nameHelp" value = "<?php echo $getprev['factoryname']; 
                echo ' '; echo $getprev['factoryaddress'];?>" disabled="disabled"  >
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputFarm">จำนวนส่งออกผลิตภัณฑ์</label>
                <input class="form-control" name="amount" type="text" aria-describedby="nameHelp" value="<?php echo $getprev['p_amount'];?>" disabled="disabled">
              </div>
              <div class="col-md-6">
                <label for="exampleInputFarm">หน่วย</label>
                <input class="form-control" name="unit" type="text" aria-describedby="nameHelp" value="<?php echo $getprev['p_unit'];?>" disabled="disabled" >
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <textarea class="form-control" name="process" type="text" aria-describedby="nameHelp" disabled="disabled"> <?php echo $getprev['p_process'];?> </textarea>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="mfddate" value="<?php echo $getprev['p_mfd'];?>" disabled="disabled" />
              </div>
              <div class="col-md-6">
                <label for="exampleInputFarm">วันที่หมดอายุของผลิตภัณฑ์</label>
                <input type="text" class="form-control" name="expdate" value="<?php echo $getprev['p_exp'];?>" disabled="disabled" />
              </div>
            </div>
          </div>
